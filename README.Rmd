...
1.   **Adaptable Text Size**. The `base_size` parameter sets a standard font size from which relative sizes of other text elements are calculated.
1.   **UGent Colour Theme**. The theme uses UGent blue `#1E64C8` as its base colour.
1.   **Faculty Colours**. The `faculty_colour` parameter specifies faculty colours through character shortcodes like "EB" for the Faculty of Economics and Business Administration.
